...
class TicketView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return  SizedBox(
      ...
      height: AppLayout.getHeight(GetPlatform.isAndroid==true?178:179),
      child: Container(
          ...
          children: [
            ...
            Container(
              ...
              color: isColor==null? const Color(0xFF526799): Colors.white,
                borderRadius: BorderRadius.only(topLeft: const Radius.circular(21), topRight: Radius.circular(AppLayout.getHeight(21)))
              ),
